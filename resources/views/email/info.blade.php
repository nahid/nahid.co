								...
								<tr><!--content-->
									<td valign="middle" bgcolor="#ebebeb" height="30" style="vertical-align: middle; border-bottom-color: #d6d6d6; border-bottom-width: 1px; border-bottom-style: solid;">
										<p style="font-size: 11px; font-weight: bold; color: #8a8a8a; text-align: center;">
											You're receiving this newsletter because you send message to <a href="http://nahid.co" style="color: #fd2323; text-decoration: none;">nahid.co</a>. You can <webversion style="color: #fd2323; text-decoration: none;">view it in your web browser</webversion>.
										</p>
									</td>
								</tr>
								<tr>
											...
											<tbody>
														...
														<table cellspacing="0" border="0" cellpadding="0" width="100%">
															<tr>
																<td valign="middle" height="37" style="height: 37px; border-bottom-color: #d6d6d6; border-bottom-width: 1px; border-bottom-style: solid; vertical-align: middle;">
																	<h2 style="margin: 0; padding: 0; font-size: 16px; font-weight: bold; color: #fd2323; text-align: left;">Dear {{$msg->name}},</h2>
																</td>
															</tr>
															<tr>
																<td valign="top">
																	<p style="margin: 0; margin-top: 7px; margin-bottom: 20px; padding: 0; font-size: 13px; font-weight: normal; color: #535353; line-height: 22px; text-align: justify;">
                                                                        ...
                                                                        Thank you, <br/>
                                                                        Nahid Bin Azhar<br/>
                                                                        <a href="http://nahid.co">http://nahid.co</a>
												...
												<tr>
													<td valign="middle" height="58" style="height: 58px; vertical-align: middle; border-top-color: #d6d6d6; border-top-width: 1px; border-top-style: solid;">
														<p style="font-size: 11px; font-weight: bold; color: #8a8a8a; text-align: center;">
															Don't want to receive these newsletters anymore? Manage your <preferences style="color: #fd2323; text-decoration: none;">email preferences here</preferences>, or <unsubscribe style="color: #fd2323; text-decoration: none;">unsubscribe</unsubscribe>.
														</p>
													</td>
												</tr>
											</tbody>
